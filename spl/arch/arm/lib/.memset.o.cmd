cmd_spl/arch/arm/lib/memset.o := arm-linux-gnueabi-gcc -Wp,-MD,spl/arch/arm/lib/.memset.o.d  -nostdinc -isystem /home/steward/Github/f1c100s_toolchain/x64/bin/../lib/gcc/arm-linux-gnueabi/7.2.1/include -Iinclude    -I./arch/arm/thumb1/include -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -D__ASSEMBLY__ -g -D__ARM__ -Wa,-mimplicit-it=always -mabi=aapcs-linux -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv5te -D__LINUX_ARM_ARCH__=5 -I./arch/arm/mach-sunxi/include -DMEMSET_NO_THUMB_BUILD   -c -o spl/arch/arm/lib/memset.o arch/arm/lib/memset.S
