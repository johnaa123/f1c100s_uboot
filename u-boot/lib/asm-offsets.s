...
@ -I ./arch/arm/include -I ./arch/arm/mach-sunxi/include -imultilib .
@ -imultiarch arm-linux-gnueabi
@ -iprefix /home/steward/Github/f1c100s_toolchain/x64/bin/../lib/gcc/arm-linux-gnueabi/7.2.1/
@ -isysroot /home/steward/Github/f1c100s_toolchain/x64/bin/../arm-linux-gnueabi/libc
@ -D __KERNEL__ -D __UBOOT__ -D __ARM__ -D __LINUX_ARM_ARCH__=5
@ -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /home/steward/Github/f1c100s_toolchain/x64/bin/../lib/gcc/arm-linux-gnueabi/7.2.1/include
...
@ lib/asm-offsets.c:22: 	DEFINE(GENERATED_GBL_DATA_SIZE,
	.loc 1 22 0
	.syntax divided
...
@ 0 "" 2
@ lib/asm-offsets.c:25: 	DEFINE(GENERATED_BD_INFO_SIZE,
	.loc 1 25 0
@ 25 "lib/asm-offsets.c" 1
	
.ascii "->GENERATED_BD_INFO_SIZE #80 (sizeof(struct bd_info) + 15) & ~15"	@
@ 0 "" 2
@ lib/asm-offsets.c:28: 	DEFINE(GD_SIZE, sizeof(struct global_data));
	.loc 1 28 0
@ 28 "lib/asm-offsets.c" 1
	
.ascii "->GD_SIZE #200 sizeof(struct global_data)"	@
@ 0 "" 2
@ lib/asm-offsets.c:30: 	DEFINE(GD_BD, offsetof(struct global_data, bd));
	.loc 1 30 0
@ 30 "lib/asm-offsets.c" 1
	
.ascii "->GD_BD #0 offsetof(struct global_data, bd)"	@
@ 0 "" 2
@ lib/asm-offsets.c:32: 	DEFINE(GD_MALLOC_BASE, offsetof(struct global_data, malloc_base));
	.loc 1 32 0
@ 32 "lib/asm-offsets.c" 1
	
.ascii "->GD_MALLOC_BASE #148 offsetof(struct global_data, malloc_base)"	@
@ 0 "" 2
@ lib/asm-offsets.c:35: 	DEFINE(GD_RELOCADDR, offsetof(struct global_data, relocaddr));
	.loc 1 35 0
@ 35 "lib/asm-offsets.c" 1
	
.ascii "->GD_RELOCADDR #48 offsetof(struct global_data, relocaddr)"	@
@ 0 "" 2
@ lib/asm-offsets.c:37: 	DEFINE(GD_RELOC_OFF, offsetof(struct global_data, reloc_off));
	.loc 1 37 0
@ 37 "lib/asm-offsets.c" 1
	
.ascii "->GD_RELOC_OFF #68 offsetof(struct global_data, reloc_off)"	@
@ 0 "" 2
@ lib/asm-offsets.c:39: 	DEFINE(GD_START_ADDR_SP, offsetof(struct global_data, start_addr_sp));
	.loc 1 39 0
@ 39 "lib/asm-offsets.c" 1
	
.ascii "->GD_START_ADDR_SP #64 offsetof(struct global_data, start_addr_sp)"	@
@ 0 "" 2
@ lib/asm-offsets.c:41: 	DEFINE(GD_NEW_GD, offsetof(struct global_data, new_gd));
	.loc 1 41 0
@ 41 "lib/asm-offsets.c" 1
	
.ascii "->GD_NEW_GD #72 offsetof(struct global_data, new_gd)"	@
@ 0 "" 2
...
.LASF154:
	.ascii	"/home/steward/Downloads/u-boot\000"
.LASF109:
	.ascii	"images\000"
.LASF107:
	.ascii	"state\000"
...
.LASF152:
	...
	.ascii	"abi=aapcs-linux -mword-relocations -mfloat-abi=soft"
	.ascii	" -march=armv5te -mtune=cortex-a9 -mtls-dialect=gnu "
	.ascii	"-g -Os -fno-builtin -ffreestanding -fshort-wchar -f"
