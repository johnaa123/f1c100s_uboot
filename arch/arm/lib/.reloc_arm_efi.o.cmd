cmd_arch/arm/lib/reloc_arm_efi.o := arm-linux-gnueabi-gcc -Wp,-MD,arch/arm/lib/.reloc_arm_efi.o.d  -nostdinc -isystem /home/steward/Github/f1c100s_toolchain/x64/bin/../lib/gcc/arm-linux-gnueabi/7.2.1/include -Iinclude    -I./arch/arm/thumb1/include -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -fshort-wchar -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -D__ARM__ -Wa,-mimplicit-it=always -mthumb -mthumb-interwork -mabi=aapcs-linux -mword-relocations -fno-common -msoft-float -pipe -march=armv5te -D__LINUX_ARM_ARCH__=5 -I./arch/arm/mach-sunxi/include -fpic -fshort-wchar    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(reloc_arm_efi)"  -D"KBUILD_MODNAME=KBUILD_STR(reloc_arm_efi)" -c -o arch/arm/lib/reloc_arm_efi.o arch/arm/lib/reloc_arm_efi.c
